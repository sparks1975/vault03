...
export const APPROVED_CARD_SETS = [
  ...
  "Fleer E-X2000",
  "Fleer SkyBox",
  "Fleer SkyBox Dugout Axcess",
  "Fleer SkyBox E-X Century",
  "Fleer Sports Illustrated",
  "Fleer Hardball",
  "Fleer Patchworks",
  "Fleer Box Score",
  // ---- Donruss / Leaf (vintage era) ----
  "Donruss Studio",
  ...
  "Topps Kmart",
  "Topps Woolworth",
  "Topps Glossy All-Stars",
  "Topps Glossy Send-Ins",
  "Topps Pre-Season",
  "Topps Star Wars-Style Inserts",
  "O-Pee-Chee",
  "O-Pee-Chee Premier",
