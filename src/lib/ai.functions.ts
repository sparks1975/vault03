...
export const estimateCardValue = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) => {
    ...
    // accurate than guessing keywords. The sold-sales search is the fallback for
    // cards with no catalog link (or no sales on the catalog card).
